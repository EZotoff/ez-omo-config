...
retired_reason: "DCP replaced by @cortexkit/opencode-magic-context. MC's m[0]/m[1] cache layout with decay rendering architecturally solves the same problem (unbounded summary growth) without requiring manual token caps."
