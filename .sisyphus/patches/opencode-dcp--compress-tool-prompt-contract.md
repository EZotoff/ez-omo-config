...
retired_reason: "DCP replaced by @cortexkit/opencode-magic-context. MC has no compress tool — it transforms messages inline on every LLM round-trip. The entire class of 'model wastes turns announcing compression' is eliminated by design."
