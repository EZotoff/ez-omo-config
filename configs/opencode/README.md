...
| `output-shaper.mjs` | Config-layer plugin: terseness injection + reasoning-effort dialing for resume turns; file-based logging at `~/.config/opencode/output-shaper.log` | `$HOME/.config/opencode/output-shaper.mjs` |
