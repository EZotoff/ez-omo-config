...
- `small_model` — Lightweight model used by built-in OpenCode helper agents, including automatic session title generation (currently `ollama-cloud/deepseek-v4-flash:0731`, moved from `opencode-go/deepseek-v4-flash` on 2026-08-27; a local FLARE-4B trial was parked 2026-08-15 — VRAM contention with ComfyUI)
