...
ITEMS=(
    ...
    "commands|commands/handoff.md|$HOME/.config/opencode/command/handoff.md"
    "commands|commands/resume-from.md|$HOME/.config/opencode/command/resume-from.md"
    "commands|commands/design-review.md|$HOME/.config/opencode/command/design-review.md"
    "commands|commands/option-compare.md|$HOME/.config/opencode/command/option-compare.md"
    ...
    "skills|skills/postmortem-policy|$HOME/.config/opencode/skills/postmortem-policy"
    "skills|skills/handoff-relay|$HOME/.config/opencode/skills/handoff-relay"
    "skills|skills/verify-built|$HOME/.config/opencode/skills/verify-built"
    "skills|skills/inbound-triage|$HOME/.config/opencode/skills/inbound-triage"
    "skills|skills/typographic-writing|$HOME/.config/opencode/skills/typographic-writing"
