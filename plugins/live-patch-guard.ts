...
// and the 2026-07-22 binary rebuild incident both lost tracked patches because
// no plugin watched these operations. See:
...
interface DetectionResult {
	readonly kind: "binary-swap" | "plugin-install" | "none"
