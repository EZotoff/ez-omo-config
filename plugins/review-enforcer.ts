...
// Export contract: the opencode plugin loader (getLegacyPlugins) calls EVERY function
// export of this module as a plugin constructor — this file may export ONLY the plugin
// function + default. Pure test-importable helpers live in ./review-enforcer/helpers
// (2026-09-08 incident: exported helpers were invoked with PluginInput and threw
// `output.includes is not a function`, failing plugin load on every fresh server).
import {
	SUCCESS_INDICATOR,
	boulderStatusAllowsInjection,
	detectFailure,
	detectRecursion,
	isAbortStub,
	isConsultativeDispatch,
	isDegenerateOutput,
	safeStringifyArgs,
	sessionOwnsBoulder,
} from "./review-enforcer/helpers"
