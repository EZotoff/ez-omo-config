...
SKILL_KNOWLEDGE_PATH="${WISDOM_MIGRATION_SKILL_KNOWLEDGE_PATH:-${HOME}/.config/opencode/skills/knowledge}"
...
Environment overrides:
  ...
  WISDOM_MIGRATION_SKILL_KNOWLEDGE_PATH
...
backup_phase() {
    ...
    if [[ -e "$SKILL_KNOWLEDGE_PATH" ]]; then
        sources+=("$SKILL_KNOWLEDGE_PATH")
    fi
