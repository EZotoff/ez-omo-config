...
assert_file_exists "plugins/auto-checkpoint.ts"
...
assert_grep 'review-enforcer/helpers' "plugins/README.md"
assert_grep 'auto-checkpoint.ts' "plugins/README.md"

plugin_sources=(
    "plugins/worktree.ts"
    "plugins/git-safety.ts"
    "plugins/review-enforcer.ts"
    "plugins/review-enforcer/helpers.ts"
    "plugins/auto-checkpoint.ts"
