...
expected_agent_fallbacks = {
    ...
    'oracle': ['kimi-for-coding-oauth/kimi-for-coding', 'zai-coding-plan/glm-5.3', 'google/gemini-3.1-pro-preview'],
    'prometheus': ['zai-coding-plan/glm-5.3', 'openai/gpt-5.6-sol'],
