...
run_case "ollama-dsv4-clamped"
run_case "ollama-m3-not-clamped"
run_case "ocg-m3-not-clamped"
run_case "ollama-m3-not-clamped"
run_case "deepseek-clamped"
run_case "opencode-go-clamped"
run_case "claude-resume-not-clamped"
run_case "copilot-resume-not-clamped"
run_case "new-question-not-clamped"
run_case "option-vocabulary"
